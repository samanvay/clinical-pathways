...
export default class FacilitySelection extends BaseComponent {
    ...
    facilitySelected(event) {
        FacilitySelectionAction.facilitySelected(this.state, event.target.value).then(this.setState);
    }
            ...
            <Grid>
                <Col>
                    <div className="form-group">
                        ...
                        <select className="form-control" id="facility" onChange={this.facilitySelected} value={this.state.selectedFacility.name}>
